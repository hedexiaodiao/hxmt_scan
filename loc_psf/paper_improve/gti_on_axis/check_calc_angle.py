...
###for i in range(0,q1_list.shape[0]):
###    quat1 = [q1_list[i],q2_list[i],q3_list[i]]
quat1 = [0.6179892, 0.37605706, 0.5467635]
...
delta_alfa = delta_alfa0 * cos(roll) - delta_beta0 * sin(roll)
delta_beta = delta_alfa0 * sin(roll) + delta_beta0 * cos(roll)
...
quat_list.append(quat1)

print(accept_alpha[0],accept_beta[0],quat_list[0])
