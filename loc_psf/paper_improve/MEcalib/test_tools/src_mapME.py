...
'''
import sys
sys.path.append("/hxmt/home/saina/tar/tools/")
...
def src_map(cfg,rac,decc):
    ...
    np.savetxt("maxi&integral&swift.dat",src_map_sel.T,fmt="%s")
    np.savetxt("maxi&integral&swift_name.dat",src_map_sel_name.T,fmt="%s")
