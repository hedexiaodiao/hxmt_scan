...
###print(attall)
fitstogetherMulti(lc0all,outpath+'/A01_me_b0.fits')
fitstogetherMulti(lc1all,outpath+'/A01_me_b1.fits')
fitstogetherMulti(lc2all,outpath+'/A01_me_b2.fits')
fitstogetherMulti(attall,outpath+'/A01_me_att.fits')
